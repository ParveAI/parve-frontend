    ...
    <div className="w-full min-h-full mt-[120px] flex flex-col items-center justify-center">
      ...
      <div className="min-h-full max-w-[900px] px-8 text-zinc-200">
        <p className="min-h-full font-[CabinetGrotesk-ExtraBold] text-3xl max-md:text-2xl">
          ...
          shared passion for technology, learning, and community collaboration.
          The project originated with the ambition to participate in the
          'Supabase Launch Week 8 Hackathon' and to contribute to the
          advancement of knowledge dissemination.
          <br />
          <br />
          The inspiration behind <span className="text-main">
            Parve AI
          </span>{" "}
          lies in the convergence of artificial intelligence and the human quest
          for knowledge. By capturing images of written content and utilizing
          AI-driven algorithms, <span className="text-main">Parve AI</span>
          transforms the way we engage with information, providing comprehensive
          solutions and explanations for a diverse range of questions spanning
          various subjects.
          <br />
          <br />
          As advocates of open-source development, we have chosen to make Parve
          AI entirely open-source. All project details, code repositories, and
          related information can be accessed on our GitHub repositories and
          associated accounts. Our commitment to transparency and collaboration
          is a fundamental aspect of our project's ethos.
          <br />
          <br />
          <span className="text-main">Parve AI</span> is a testament to the
          potential of technology to bridge the gap between complex subjects and
          curious minds. Our journey is fueled by the desire to empower users
          with a deeper understanding of the world around them and to foster a
          community where knowledge is accessible, shareable, and
          ever-expanding.
        </p>
        <br />
        <br />
        <div className="min-h-full font-[CabinetGrotesk-Bold] text-2xl">
          ...
          <br />
          <span className="text-main">Parve AI</span> is an innovative platform
          that leverages artificial intelligence to decipher and explain the
          contents of an image containing text. Whether it pertains to
          mathematics, physics, psychology, philosophy, software, or any other
          field, <span className="text-main">Parve AI</span> uses advanced AI
          algorithms to analyze and solve questions embedded within the image,
          providing detailed explanations for the answers.
          <br />
          <br />
          <span className="text-3xl font-[CabinetGrotesk-ExtraBold] text-white">
            Introduction
          ...
          platform empowers users to capture images of written material and gain
          insightful explanations for complex queries across diverse subjects.
          <br />
          <br />
          <span className="text-3xl font-[CabinetGrotesk-ExtraBold] text-white">
            Key Features
          ...
          <br />
          Image-based Question Solving: Users capture images of text, and Parve
          AI employs state-of-the-art artificial intelligence to understand and
          solve questions, ensuring comprehensive explanations for each answer.
          <br />
          <br />
          Collective Knowledge: <span className="text-main">Parve AI</span>{" "}
          allows users to organize and categorize their questions through
          customizable collection pages, streamlining information retrieval and
          organization.
          <br />
          <br />
          ...
          conceived by two passionate computer science and science students with
          the goal of participating in the 'Supabase Launch Week 8 Hackathon'
          and providing assistance to the community.
          <br />
          <br />
          <span className="text-3xl font-[CabinetGrotesk-ExtraBold] text-white">
            Future Developments
          ...
          platform; it's a gateway to understanding and exploration, uniting the
          realms of technology and knowledge in an innovative and user-centric
          manner.
          <br />
          <br />
          <br />
